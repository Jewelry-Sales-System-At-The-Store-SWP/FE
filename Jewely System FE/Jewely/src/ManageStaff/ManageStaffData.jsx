...
const handleClick = () => {
  ...
  return (
    ...
    <main className="main">
      ...
      <section className="absolute top-[285px] left-[326px] shadow-[0px_6.3px_37.5px_rgba(226,_236,_249,_0.5)] rounded-[18.75px] bg-white w-[1041.5px] flex flex-row items-start justify-start max-w-full" style={{ minHeight: '600px' }}>
        <form className="m-0 flex-1 shadow-[0px_6.3px_37.5px_rgba(226,_236,_249,_0.5)] rounded-[18.75px] bg-white flex flex-col items-start justify-start pt-[13.3px] px-0 pb-[42px] box-border gap-[33.4px] max-w-full z-[3]" style={{ minHeight: '600px' }}>
          <img
          ...
          <div className="self-stretch flex flex-row items-start justify-start py-0 pr-[47px] pl-10 box-border max-w-full">
            <div className="flex-1 flex flex-row items-end justify-between max-w-full gap-[20px] mq925:flex-wrap">
                    ...
                    {data
                      ...
                      .map((item, index) => (
                        <tr key={index} className="staff-table">
                          ...
                          <td className="absolute left-[203px]">
                            {item.counter}1
                          </td>
                          <td className="absolute left-[300px]">phone</td>
                          <td className="absolute left-[495px]">
                            {item.email}
                          </td>
              ...
              <div className="absolute top-[37.3px] ml-42.5 left-[380px] flex gap-[6.25px]"> 
                <div 
                onClick={handleClick}
                className="flex w-[97px] h-[28px] items-center justify-center gap-[6.25px] px-[7.5px] py-[2.5px] bg-[#15c09861] rounded-[2.5px] border-[0.63px] mr-[0px] border-solid border-[#00b086]">
          ...
          <div className="absolute top-[133px] left-[15px] box-border w-[1000px] h-[0.6px] z-[1] border-t-[0.6px] border-solid border-whitesmoke-200" />

          <div className="header data absolute top-[110px]">
